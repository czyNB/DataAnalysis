...
def generate_dir():
    ...
    shutil.copy('../../doc/origin/code_variable_detailed.json', '../../data/analysis/code_variable_detailed.json')
    shutil.copy('../../doc/origin/code_chaos_detailed.json', '../../data/analysis/code_chaos_detailed.json')
    shutil.copy('../../doc/origin/code_reuse_detailed.json', '../../data/analysis/code_reuse_detailed.json')
