...
def generate_dir():
    ...
    shutil.copy('../../doc/data/code_chaos.json', '../../data/analysis/code_chaos.json')
    shutil.copy('../../doc/data/code_reuse.json', '../../data/analysis/code_reuse.json')
    shutil.copy('../../doc/data/code_variable.json', '../../data/analysis/code_variable.json')
    shutil.copy('../../doc/data/graph_difficulty.png', '../../data/analysis/graph_difficulty.png')
    shutil.copy('../../doc/data/iterator_topic.json', '../../data/analysis/iterator_topic.json')
    shutil.copy('../../doc/data/iterator_user.json.json', '../../data/analysis/iterator_user.json')
    shutil.copy('../../doc/data/pre_cpp.json', '../../data/analysis/pre_cpp.json')
    shutil.copy('../../doc/data/pre_test.json', '../../data/analysis/pre_test.json')
    shutil.copy('../../doc/data/topic_color.json', '../../data/analysis/topic_color.json')
    shutil.copy('../../doc/data/topic_difficulty.json', '../../data/analysis/topic_difficulty.json')
    shutil.copy('../../doc/data/topic_sequence.json', '../../data/analysis/topic_sequence.json')
    shutil.copy('../../doc/data/type_weight.json', '../../data/analysis/type_weight.json')
    shutil.copy('../../doc/data/user_rank.json', '../../data/analysis/user_rank.json')
    shutil.copy('../../doc/data/user_score.json', '../../data/analysis/user_score.json')
